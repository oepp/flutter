                ...
                Expanded(
                    child: Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              fontSize: 16, color: ColorPalette.clouds),
                        ))),
                Container(
                  width: double.infinity,
                  margin: EdgeInsets.all(10),
                  child: Text(
                      "Created by ${_gameInfo.creator} on ${_gameInfo.creationTime.substring(0, 7)}",
                      style:
                          TextStyle(fontSize: 12, color: ColorPalette.clouds),
